...
//////////////// END
                ...
                out.write(`CORBA::async<std::shared_ptr<${if_identifier}>> ${if_identifier}::_narrow(std::shared_ptr<CORBA::Object> pointer) {\n`)
                ...
                out.write(`            co_return std::shared_ptr<${if_identifier}>();\n`)
                out.write(`        }\n`)
                out.write(`        std::shared_ptr<CORBA::ORB> orb = ref->get_ORB();\n`)
                out.write(`        CORBA::detail::Connection *conn = co_await orb->getConnection(ref->host, ref->port);\n`)
                out.write(`        auto stub = std::make_shared<${if_identifier}_stub>(orb, CORBA::blob_view(ref->objectKey), conn);\n`)
                out.write(`        co_return std::dynamic_pointer_cast<${if_identifier}>(stub);\n`)
                out.write(`    }\n`)
                out.write(`    auto obj = dynamic_cast<${if_identifier}*>(ptr);\n`)
                out.write(`    if (obj) {\n`)
                out.write(`        co_return std::dynamic_pointer_cast<${if_identifier}>(pointer);\n`)
                out.write(`    }\n`)
                out.write(`    co_return std::shared_ptr<${if_identifier}>();\n`)
                out.write(`}\n\n`)
            } break
