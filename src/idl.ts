...
function usage() {
    console.log("glue.js IDL compiler")
    console.log("Usage: glue.idl [--ts-stub|--ts-skel] file")
}
...
try {
    ...
    switch(process.argv[2]) {
        case "--ts-stub":
            ...
            out.write("// This file is generated by the glue.js IDL compiler from '"+fileName+"'.\n\n")
            out.write("import { ORB, Stub } from 'glue.js'\n\n")
            generator = new Generator(generatorTSStub, out)
            break
        case "--ts-skel":
            out = fs.createWriteStream(fileNamePrefix+"_skel.ts")
            out.write("// This file is generated by the glue.js IDL compiler from '"+fileName+"'.\n\n")
            out.write("import { ORB, Skeleton } from 'glue.js'\n\n")
